...
/// </summary>
public abstract class AddDeviceRequestValidator : AbstractValidator<AddDeviceRequest>
{
    /// <summary>
    /// Метод, конструктор, устанавливающий правила
    /// </summary>
    protected AddDeviceRequestValidator() 
    {
    ...
    /// </summary>
    private static bool BeSupported(string location)
    {
